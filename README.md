...
<div>
  <img src="./assets/screenshots/discover-feed.png" width="240" style="border-radius:8px; display: block;">
  <img src="./assets/screenshots/writing-space.png" width="240" style="border-radius:8px; display: block;">
  <img src="./assets/screenshots/create-story.png"  width="240" style="border-radius:8px; display: block;">
  <img src="./assets/screenshots/my-library.png"  width="240" style="border-radius:8px; display: block;">
</div>
...
<img src="./assets/database-schema.svg" width="700" style="border-radius:8px;">
</div>
